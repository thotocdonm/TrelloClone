            ...
            <ThemedView style={{ flex: 1 }}>
                ...
                <View style={styles.cardRow}>
                    ...
                    {users.map((user, index) => (
                            <View style={{height: 50, width:50, borderRadius:50, backgroundColor:"blue", flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 10}} key={index}>
                                <Text style={{textAlign:"center", textAlignVertical:"center", color:"white",height: 50, width:50, borderRadius:50, backgroundColor:"blue"}}>{user.username}</Text>
                            </View>
                        
                    ))}

                    <Pressable onPress={() => {navigation.navigate("AddMember",{user:users, workspaceId: route.params.workspaceId})}}>
                        <ThemedText style={{marginLeft:30,textAlignVertical: 'center',textAlign: 'center', backgroundColor: 'blue', borderRadius: 3, overflow: 'hidden', width: 60, height: 40 , alignContent:'center'}}>Quản lý</ThemedText>
